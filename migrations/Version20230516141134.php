...
final class Version20230516141134 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE images CHANGE products_id products_id_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE images ADD CONSTRAINT FK_E01FBE6A9F1D6087 FOREIGN KEY (products_id_id) REFERENCES products (id)');
        $this->addSql('CREATE INDEX IDX_E01FBE6A9F1D6087 ON images (products_id_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE images DROP FOREIGN KEY FK_E01FBE6A9F1D6087');
        $this->addSql('DROP INDEX IDX_E01FBE6A9F1D6087 ON images');
        $this->addSql('ALTER TABLE images CHANGE products_id_id products_id INT DEFAULT NULL');
