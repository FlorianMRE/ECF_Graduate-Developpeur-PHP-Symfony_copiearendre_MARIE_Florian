...
final class Version20230522093426 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE opening_hours (id INT AUTO_INCREMENT NOT NULL, week_day VARCHAR(15) NOT NULL, am_open DATETIME DEFAULT NULL, am_close DATETIME DEFAULT NULL, pm_open DATETIME DEFAULT NULL, pm_close DATETIME DEFAULT NULL, close_day TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
